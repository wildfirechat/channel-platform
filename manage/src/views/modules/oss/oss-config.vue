    ...
    <el-dialog title="云存储配置" :close-on-click-modal="false" :visible.sync="visible">
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
            ...
            <template v-else-if="dataForm.type === 4">
                <el-form-item label="域名">
                    <el-input v-model="dataForm.minioDomain" placeholder="Minio 绑定的域名"></el-input>
                </el-form-item>
                <el-form-item label="路径前缀">
                    <el-input v-model="dataForm.minioPrefix" placeholder="不设置默认为空"></el-input>
                </el-form-item>
                <el-form-item label="EndPoint">
                    <el-input v-model="dataForm.minioEndPoint" placeholder="Minio EndPoint"></el-input>
                </el-form-item>
                <el-form-item label="AccessKeyId">
                    <el-input v-model="dataForm.minioAccessKeyId" placeholder="Minio AccessKeyId"></el-input>
                </el-form-item>
                <el-form-item label="AccessKeySecret">
                    <el-input v-model="dataForm.minioAccessKeySecret" placeholder="Minio AccessKeySecret"></el-input>
                </el-form-item>
                <el-form-item label="BucketName">
                    <el-input v-model="dataForm.minioBucketName" placeholder="Minio BucketName"></el-input>
                </el-form-item>
            </template>
        </el-form>
